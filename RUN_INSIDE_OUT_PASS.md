...
- **Regression is sacred.** Phase 6A baseline is 2717 passing. Breaking any passing test is higher priority than any new work.
...
- **Baseline integrity:** test count after Phase 3 ≥ 2717 passing. Any failure is a regression to fix forward.
...
2. Test count vs baseline (2717 passing; no new failures)
...
- `pytest` baseline — 2717 passing, 0 failures, 0 errors. STOP if any failure or error.
